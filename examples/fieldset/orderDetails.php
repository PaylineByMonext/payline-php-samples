    	...
    	<tr>
    		<td>
    			<div class="row">
					...
					<input type="text" name="orderDetailRef1" id="orderDetailRef1" value="" maxlength="50" />
				</div>
				<div class="row">
					<label for="orderDetailPrice1">Item 1 price</label>
					<input type="text" name="orderDetailPrice1" id="orderDetailPrice1" value="" />
				</div>
				<div class="row">
					<label for="orderDetailQuantity1">Item 1 quantity</label>
					<input type="text" name="orderDetailQuantity1" id="orderDetailQuantity1" value="" />
				</div>
				<div class="row">
					<label for="orderDetailComment1">Item 1 comment</label>
					<textarea name="orderDetailComment1" id="orderDetailComment1"></textarea>
				</div>
				<div class="row">
					<label for="orderDetailCategory1">Item 1 category</label>
					<input type="text" name="orderDetailCategory1" id="orderDetailCategory1" value="" />
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<input type="text" name="orderDetailBrand1" id="orderDetailBrand1" value="" />
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<input type="text" name="orderDetailTaxRate1" id="orderDetailTaxRate1" value="" />
				</div>
    		</td>
    		<td>
    			<div class="row">
					<label for="orderDetailRef2">Item 2 reference</label>
					<input type="text" name="orderDetailRef2" id="orderDetailRef2" value="" maxlength="50" />
				</div>	
				<div class="row">
					<label for="orderDetailPrice2">Item 2 price</label>
					<input type="text" name="orderDetailPrice2" id="orderDetailPrice2" value="" />
				</div>
				<div class="row">
					<label for="orderDetailQuantity2">Item 2 quantity</label>
					<input type="text" name="orderDetailQuantity2" id="orderDetailQuantity2" value="" />
				</div>
				<div class="row">
					<label for="orderDetailComment2">Item 2 comment</label>
					<textarea name="orderDetailComment2" id="orderDetailComment2"></textarea>
				</div>
				<div class="row">
					<label for="orderDetailCategory2">Item 2 category</label>
					<input type="text" name="orderDetailCategory2" id="orderDetailCategory2" value="" />
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<input type="text" name="orderDetailBrand2" id="orderDetailBrand2" value="" />
				</div>
				<div class="row">
				...
				<div class="row">
					...
					<input type="text" name="orderDetailTaxRate2" id="orderDetailTaxRate2" value="" />
				</div>   
    		</td>
    	</tr>
    </table>       
