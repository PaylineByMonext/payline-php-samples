...
echo "	<input type='radio' name='".$response['termUrlName']."' value='".KIT_ROOT."examples/demos/direct.php' checked>call doAuthorization<br/>";
echo "	<input type='radio' name='".$response['termUrlName']."' value='".KIT_ROOT."examples/demos/wallet.php'>call doImmediateWalletPayment<br/>";
